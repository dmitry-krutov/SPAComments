        ...
        <div className="mt-6 grid gap-4 md:grid-cols-[auto,1fr] md:items-center">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/10 px-3 py-2 text-xs text-white transition hover:border-brand-300 hover:text-white"
            >
              Обновить капчу
            </button>
          </div>
